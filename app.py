            ...
            if isinstance(file_id, str) and file_id.startswith('email_attachment:'):
                ...
                if m:
                    ...
                    for anx in anexos:
                        ...
                        if need_ai:
                            try:
                                model_name = st.session_state.get('cfg_model', 'qwen/qwen3.7-flash:nitro')
...
st.session_state.cfg_model = "qwen/qwen3.7-flash:nitro"
if "cfg_classificar_emails_com_ia" not in st.session_state:
...
if pagina_sidebar == "Configurações":
    ...
    with aba_ia_cfg:
        st.caption("Modelo principal: qwen/qwen3.7-flash:nitro")
