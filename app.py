            ...
            if isinstance(file_id, str) and file_id.startswith('email_attachment:'):
                ...
                if m:
                    ...
                    for anx in anexos:
                        ...
                        if need_ai:
                            try:
                                model_name = st.session_state.get('cfg_model', 'deepseek/deepseek-v4-flash-0731')
...
st.session_state.cfg_model = "deepseek/deepseek-v4-flash-0731"
if "cfg_classificar_emails_com_ia" not in st.session_state:
...
if pagina_sidebar == "Configurações":
    ...
    with aba_ia_cfg:
        st.caption("Modelo principal: deepseek/deepseek-v4-flash-0731")
