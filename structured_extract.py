...
_HEADER_KEYWORDS = {
    "item", "descricao", "nomenclatura", "nome", "material", "objeto",
    "qtd", "quantidade", "valor", "preco", "unitario", "numero", "num", "n",
    "pi", "nsn", "codigo"
}
...
def _extrair_itens_pdf_por_linhas(path: str) -> dict:
    ...
    with pdfplumber.open(path) as pdf:
        ...
        while idx < len(linhas_tabela):
            ...
            numero_item = linha
            codigo_pi = proxima_linha  # PI/NSN: identificador unico do material
